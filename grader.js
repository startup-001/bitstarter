...
var URL_DEFAULT = "http://young-lake-6693.herokuapp.com";
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <link>', 'URL to check', clone(assertUrlExists) )
        .parse(process.argv);
    ...
    else if( program.file )
    {
      ...
      RunChecks( htmlFile, program.checks);
    }
    else
    {
      //Usage
